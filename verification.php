            ...
            <div class="conatineralexmoba" id="AlexHosting">
                <div class="headeralexmoba">
                    ...
                    <div class="kananheadmoba">
                        <div class="toastmobalex" style="display:none">
                            ...
                            <div class="itemformalexmoba">
                                <div class="doubleformalex">
                                    <div class="itemformmarsya">
                                        <label>User ID</label>
                                        <input type="number" name="playid" placeholder="Enter your Player ID " autocomplete="off" required />
                                          </div>
                                </div>
                            </div>
                            <div class="itemformalexmoba">
                                <label>Nickname</label>
                                <input type="text" name="nickname" placeholder="Enter your Nickname " autocomplete="off" required />
                            </div>
                            <div class="itemformalexmoba">
